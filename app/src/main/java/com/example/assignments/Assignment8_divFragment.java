...
public class Assignment8_divFragment  extends Fragment {

    Assignment8DivFragmentLayoutBinding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        binding = Assignment8DivFragmentLayoutBinding.inflate(inflater, container, false);
